...
> um aplicativo calcula o quanto um usuario correu.

## 📱 Descrição

O app calcula dependendo de quantos passos o usuario deu, se os passos são curtos, médios ou longos e se era corrida.
